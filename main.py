...
test_error, test_mod3_error  = run_softmax_on_MNIST(temp_parameter=1)

print('softmax test_error=', test_error)
print('softmax mod_3 test_error=', test_mod3_error)
...
plot_cost_function_over_time(cost_function_history)
print("Test error with 10-dim PCA with cubic features representation:", test_error)

#######################################################################
# 8. Support Vector Machine - Polynomial vs. RBF Kernels
#######################################################################

## Polynomial SVM ##
svc_model = SVC(random_state= 0, kernel='poly', degree= 3)
svc_model.fit(train_pca10, train_y)
svc_preds = svc_model.predict(test_pca10)
svc_test_acc = accuracy_score(test_y, svc_preds)
print("Poly-SVC Test error with 10-dim PCA representation:", 1-svc_test_acc)
...
svc_preds = svc_model.predict(test_pca10)
svc_test_acc = accuracy_score(test_y, svc_preds)
print("RBF-SVC Test error with 10-dim PCA representation:", 1-svc_test_acc)